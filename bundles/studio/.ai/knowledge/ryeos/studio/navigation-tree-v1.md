...
title: "Studio Project/Thread/View Navigation Tree v1"
description: "The semantic navigation tree for driving RyeOS Studio across projects, threads, thread lenses, project lenses, and node-wide operations"
entry_type: reference
version: "1.0.0"
```

# Studio Navigation Tree v1

This is the Studio product tree. It names the objects an operator drives, the
...
```text
RyeOS Studio is a project cockpit over durable threads.
...
Studio has two primary execution scopes:
...
Studio driving tree: what the next input or activation will do.
...
`builtin:studio/driving-state`, rendered by a normal `sections` or `table`
view. It should report Studio decisions, not renderer wrapper nodes.

## References

- `bundles/studio/.ai/knowledge/ryeos/studio/frame-v1.md`
- `bundles/studio/.ai/surfaces/ryeos/studio/cockpit.yaml`
- `bundles/studio/.ai/surfaces/ryeos/studio/thread.yaml`
- `bundles/studio/.ai/views/ryeos/projects/list.yaml`
...
- `crates/clients/base/src/studio/model.rs`
- `crates/clients/base/src/studio/view_model.rs`
