...
| [Cross-Platform Support](cross-platform-support.md)               | What it takes to run ryeosd on macOS, Windows, and Docker — Unix-specific code inventory, effort estimates, recommended phased approach                            |
