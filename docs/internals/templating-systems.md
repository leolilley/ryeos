...
| ------ | -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| 1      | `rye/executor/primitive_executor.py` (`_template_config` Pass 1), `lillux/primitives/subprocess.py` (`_template_env_vars`), `rye/runtime/env_resolver.py` (`_expand_variables`) |
