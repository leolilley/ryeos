...
The `BudgetLedger` is a SQLite-backed hierarchical cost tracking system at `.ai/state/threads/budget_ledger.db`. It ensures threads can't overspend their allocation.
