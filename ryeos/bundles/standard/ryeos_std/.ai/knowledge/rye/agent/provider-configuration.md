<!-- rye:signed:2026-04-19T09:49:53Z:73bcdb3809b5482ebcee0299bb86b58e749e306d37277a0412d8ec4c94ff5622:JL8m2UfyAiXHgCAXO0eExvqXbpKRyQH88cS3Kp0FCnu0chG34Rgm+UtBFCJ17GGjiG9Kp+Cye0dPDR7Nl2siBg==:8f4c002347bcb25b80e32a9f5ba7064638f0d372b8dd5cfbff3da765f94ef4bb
```yaml
...
- Reads provider tool YAMLs from `.ai/tools/rye/agent/providers/` (system) with agent config from `.ai/config/agent/agent.yaml`
...
```yaml
# .ai/tools/rye/agent/providers/anthropic.yaml (system default)
# Individual provider tool YAMLs with tier_mapping, pricing, env_config
providers:
  anthropic:
