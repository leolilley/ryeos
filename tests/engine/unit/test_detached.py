...
class TestLaunchDetached:
    ...
    async def test_success(self, tmp_path):
        ...
        with patch("rye.primitives.execute.ExecutePrimitive", return_value=mock_proc):
    ...
    async def test_exception_returns_error_dict(self, tmp_path):
        with patch(
            "rye.primitives.execute.ExecutePrimitive",
...
class TestSpawnThread:
    ...
    async def test_success_lifecycle(self, tmp_path):
        ...
        with patch("rye.primitives.execute.ExecutePrimitive",
