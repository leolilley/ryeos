...
fn render() {
    STATE.with(|s| {
        ...
        let needed = ryeos_tui_core::scene::RENDER_W * ryeos_tui_core::scene::RENDER_H * 4;
        ...
        ryeos_tui_core::scene::rasterize_to_rgba(
            &frame.background,
            &mut state.pixel_buf,
        );
        ...
        setPixels(
            ...
            state.pixel_buf.len(),
            ryeos_tui_core::scene::RENDER_W,
            ryeos_tui_core::scene::RENDER_H,
        );
    });
}
