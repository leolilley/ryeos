...
///
/// This matches the fingerprint computation in `crates/bin/daemon/src/identity.rs`.
...
/// the pattern in `crates/bin/daemon/src/auth.rs` and `crates/bin/daemon/src/identity.rs`.
#[tracing::instrument(
