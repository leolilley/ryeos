//! `ui.cockpit.schedules.list` — schedule listing for the cockpit.
//!
//! Wraps the existing scheduler listing, providing a cockpit-friendly
...
pub const DESCRIPTOR: ServiceDescriptor = ServiceDescriptor {
    service_ref: "service:ui/cockpit/schedules/list",
    endpoint: "ui.cockpit.schedules.list",
