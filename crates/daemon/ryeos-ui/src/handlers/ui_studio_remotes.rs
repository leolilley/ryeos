//! `ui.studio.remotes.list` and `ui.studio.remotes.probe` — remotes
//! inspection for the studio.
//!
...
pub const REMOTES_LIST_DESCRIPTOR: ServiceDescriptor = ServiceDescriptor {
    service_ref: "service:ui/studio/remotes/list",
    endpoint: "ui.studio.remotes.list",
...
pub const REMOTES_PROBE_DESCRIPTOR: ServiceDescriptor = ServiceDescriptor {
    service_ref: "service:ui/studio/remotes/probe",
    endpoint: "ui.studio.remotes.probe",
    availability: ServiceAvailability::DaemonOnly,
    required_caps: &[],
    handler: |params, ctx, state| {
