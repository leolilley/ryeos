...
export type RyeOsEffectKind =
   ...
   */
  | { type: "invoke_binding"; request: UiBindingRequest; request_bounds: UiBindingRequestBounds; intent: InvokeIntent; success_notice?: string | null; route_seq?: bigint | null; ratchet_on_thread_id: boolean }
