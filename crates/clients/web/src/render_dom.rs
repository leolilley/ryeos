...
use ryeos_client_base::text_surface::{Attr, Color, TextSurface};
...
impl CellStyle {
    fn from_cell(cell: ryeos_client_base::text_surface::Cell) -> Self {
        Self {
...
mod tests {
    use super::*;
    use ryeos_client_base::text_surface::{Color, Style};
