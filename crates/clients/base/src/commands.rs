...
pub fn builtin_affordances() -> Vec<Affordance> {
    vec![
        ...
        affordance(
            ...
            "Overview",
            "View",
            "Switch to operational overview",
            ui_switch(ViewKindSpec::Overview),
        ),
        affordance(
            "view.remotes",
            "Remotes",
        ...
        affordance(
            ...
            "Services",
            "View",
            "Switch to daemon services view",
            ui_switch(ViewKindSpec::Services),
        ),
        affordance(
            "view.item_inspector",
            "Item Inspector",
            ...
            ui_switch(ViewKindSpec::ItemInspector),
        ),
        affordance(
            "view.schedules",
            "Schedules",
            "View",
            "View scheduler specs and recent fires",
            ui_switch(ViewKindSpec::Schedules),
        ),
        affordance(
            "view.gc",
            "GC",
            ...
            ui_switch(ViewKindSpec::GcStatus),
        ),
        affordance(
            "view.files",
            "Files",
            "View",
            "Browse safe project files",
            ui_switch(ViewKindSpec::Files),
        ),
        affordance(
            "view.projects",
            "Projects",
...
fn parse_view_kind(s: &str) -> Option<ViewKindSpec> {
    match s {
        ...
        "overview" => Some(ViewKindSpec::Overview),
        "remotes" => Some(ViewKindSpec::Remotes),
        "services" => Some(ViewKindSpec::Services),
        "item_inspector" => Some(ViewKindSpec::ItemInspector),
        "schedules" => Some(ViewKindSpec::Schedules),
        "gc_status" | "gc" => Some(ViewKindSpec::GcStatus),
        "files" => Some(ViewKindSpec::Files),
