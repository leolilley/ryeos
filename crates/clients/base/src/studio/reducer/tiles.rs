...
impl StudioCore {
    ...
    pub(crate) fn cycle_lens(&mut self, delta: i32) -> Vec<StudioEffect> {
    ...
    pub(crate) fn switch_workspace_tab(&mut self, index: usize) -> Vec<StudioEffect> {
    ...
    pub(crate) fn open_view(&mut self, view: ViewSpec) -> Vec<StudioEffect> {
    ...
    pub(crate) fn add_center_tile(&mut self, view: ViewSpec) -> Vec<StudioEffect> {
    ...
    pub(crate) fn push_motion(&mut self, motion: StudioMotionEventVm) {
