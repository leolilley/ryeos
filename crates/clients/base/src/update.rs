...
use crate::store::{
    BundleSummaryModel, DaemonStatus, EventRecord, FileBrowserModel, FileEntryModel, FileReadModel,
    GcStatusModel, GcSummaryModel, IdentityInfoModel, IdentityModel, ItemInspectionModel,
    ItemModel, LocalNodeModel, ProjectInfoModel, ProjectModel, ScheduleListModel, ScheduleModel,
    ScheduleSummaryModel, ServiceSummaryModel, SessionModel, SpaceSummaryModel,
    StudioDimensionModel, ThreadInspectionModel, ThreadModel, ThreadStatus, ThreadUsage,
...
pub struct StudioLocalNode {
    ...
    #[serde(default)]
    pub verbs: Vec<StudioVerbAlias>,
    #[serde(default)]
    pub aliases: Vec<StudioVerbAlias>,
}
