...
impl GcEvent {
    ...
    pub fn from_result(
        ...
        Self {
            ...
            preserved_active_materialized_snapshots: result.preserved_active_materialized_snapshots,
...
mod tests {
    ...
    fn append_and_read_event() {
        ...
        let event = GcEvent {
            ...
            reachable_blobs: 20,
            reachable_large_objects: 0,
            deleted_objects: 10,
            deleted_blobs: 5,
            inspected_large_objects: 0,
            deleted_large_objects: 0,
            deleted_large_object_staging_files: 0,
            preserved_rooted_large_objects: 0,
            preserved_leased_large_objects: 0,
            freed_large_object_bytes: 0,
            deleted_cas_staging_files: 0,
            ...
            inspected_materialized_snapshots: 0,
            deleted_materialized_snapshots: 0,
