...
`ryeos-app/src/execution_provenance.rs:41-84` defines the complete
role × source matrix:
...
and post-execution foldback (`ryeos-executor/src/execution/runner.rs:775-785`).
...
`ryeos-executor/src/execution/runner.rs:241-317`. Root LiveFs ingests the
