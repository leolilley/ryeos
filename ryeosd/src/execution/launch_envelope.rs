...
mod tests {
    ...
    fn envelope_round_trip() {
        let envelope = LaunchEnvelope {
            ...
            invocation_id: "inv-abc123".to_string(),
            thread_id: "T-test".to_string(),
            roots: EnvelopeRoots {
                project_root: PathBuf::from("/project"),
                user_root: Some(PathBuf::from("/home/user")),
                system_roots: vec![PathBuf::from("/opt/rye")],
            },
            ...
            request: EnvelopeRequest {
                inputs: serde_json::json!({"task": "build"}),
        ...
        assert_eq!(parsed.target.kind, "directive");
    }
    ...
    fn runtime_result_round_trip() {
        ...
        assert_eq!(parsed.cost.unwrap().input_tokens, 1500);
    }
    ...
    fn hard_limits_defaults() {
        ...
        assert_eq!(limits.duration_seconds, 300);
    }
}
