//! Auth invoker for the `rye_signed` verifier.
//!
...
pub struct CompiledRyeSignedVerifier;

static RYE_SIGNED_CONTRACT: RouteInvocationContract = RouteInvocationContract {
    output: RouteInvocationOutput::Principal,
    principal: PrincipalPolicy::Forbidden,
};

#[axum::async_trait]
impl CompiledRouteInvocation for CompiledRyeSignedVerifier {
