# rye:signed:2026-02-15T07:11:50Z:7b4c1133e910703d718a6a638bb04e0a41c40b477f6ac5c70311790269e2a45c:Ehnmpp3qYDcJk_1dca08SKsUsGukrUptE58vGWS6BgVkj6ry_pjq8mKQHX-1LJf4ol10XvhDPZtsUS_mKKWBCw==:440443d0858f0199
...
def get_provider_config(project_path: str, provider: str | None) -> dict:
    ...
    if project_path:
        config_paths.append(Path(project_path) / AI_DIR / "config" / "websearch.yaml")

    user_config = Path(get_user_space()) / AI_DIR / "config" / "websearch.yaml"
    ...
    try:
        if provider == "exa":
            if not api_key:
                return {
                    "success": False,
                    "error": "Exa provider requires API key. Configure in .ai/config/websearch.yaml",
                }
